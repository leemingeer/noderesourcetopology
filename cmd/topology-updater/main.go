...
import (
	...
	topology "github.com/leemingeer/noderesourcetopology/pkg/topology-updater"
...
const (
	...
	ProgramName       = "ppio-topology-updater"
...
func main() {
	...
	if version.Undefined() {
		klog.InfoS("version not set! Set -ldflags \"-X github.com/leemingeer/noderesourcetopology/pkg/version.version=`git describe --tags --dirty --always`\" during build or run.")
	}
